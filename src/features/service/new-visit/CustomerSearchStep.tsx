...
export function CustomerSearchStep({
  ...
  return (
    <section
      className="new-visit-step"
      aria-labelledby="new-visit-customer-heading"
    >
        <div className="new-visit-step__heading">
    <span className="new-visit-step__number">1</span>

    <div className="new-visit-step__heading-content">
      <div>
        <h3 id="new-visit-customer-heading">
          Find Customer
        </h3>
      ...
      <button
        className="new-visit-button new-visit-button--secondary"
        type="button"
      ...
      <div
        className="new-visit-results"
        aria-live="polite"
      >
        {loading ? (
          <p className="new-visit-state">
            Loading customers…
          </p>
        ) : null}

        {!loading && error ? (
          <p className="new-visit-state new-visit-state--error">
            {error}
          </p>
        ) : null}
        ...
        {!loading && !error
          ? customers.map((customer) => (
              ...
              >
                ...
                <span className="new-visit-choice__secondary">
                  {customer.phone}
                </span>
              </button>
            ))
